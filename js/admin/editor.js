...
jQuery(function() {
	...
	function advanced_mode_on() {
		...
		jQuery( 'li.existing_map_item' ).each(function () {
			...
			jQuery( '.map_advanced_checkbox', adv ).on('click', function() {
	...
	jQuery( 'body' ).append(
		'<div id="map_container_src" style="display:none"><div id="map_container">' +
			( _agm.is_multisite ?
				...
				'<a target="_blank" href="https://cp-psource.github.io/ps-maps//#usage">' +
				'PSOURCE Maps Installation and Use instructions</a>.' +
				'</p>'
			) +
